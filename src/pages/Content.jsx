            ...
            <div className="space-y-6">
              ...
              <div className="space-y-6 text-[#30303c] text-lg leading-relaxed">
                <p>
                  ...
                  brilliantly present them, we take pride in providing the best
                  content writing services in India. Just give us all the
                  ...
                  Such that no one faces the insufficiency of the content writer
                ...
                <p>
                  ...
                  inconvenience, we are here to help you. Our expert advertising
                  content writer team has not only a vast amount of knowledge in
                  the field of marketing and advertising, but they also follow
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <div className="flex flex-col justify-center space-y-8 order-2 lg:order-1">
              ...
              <p className="text-[#3f3f3f] text-lg md:text-xl leading-relaxed max-w-lg">
                We have a dexterous team of designers & developers that works on
                clients' projects excellently and delivers the project on
                timeline.
              </p>
