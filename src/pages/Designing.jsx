...
const projectsData = [
  {
    ...
    image: "https://plus.unsplash.com/premium_photo-1661880224695-47dc8805c4ea?w=500&auto=format&fit=crop&q=60",
    category: "Logistics",
  ...
  },
  {
    ...
    image: "https://plus.unsplash.com/premium_photo-1673264303561-de2ab31df03c?q=80&w=687&auto=format&fit=crop",
    category: "E-Commerce",
    link: "#"
  },
  {
    title: "UrbanFit Gym",
    description: "Transform Your Body with Expert Trainers & Smart Fitness Plans",
  ...
  {
    title: "Foodie's Hub",
    description: "Delicious Food Delivered Fast with Premium Quality Ingredients",
  ...
  },
  {
    ...
    image: "https://media.istockphoto.com/id/1262283526/photo/indian-girl-student-wear-headphones-learning-online-watching-webinar-class-looking-at-laptop.jpg?s=2048x2048&w=is&k=20&c=1qXe3QcWLA0WkA5asYq16P1YfOhInYO1aul5NftkTk8=",
    category: "Education",
    link: "#"
  },
  {
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1521334884684-d80222895322?w=500&auto=format&fit=crop&q=60",
    category: "Fashion",
    link: "#"
  },
  {
  ...
  },
  {
    ...
    image: "https://images.unsplash.com/photo-1628348070889-cb656235b4eb?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTJ8fG1lZGljYXJlfGVufDB8fDB8fHww",
    category: "Healthcare",
    link: "#"
  }
];
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-8 pt-12 lg:pt-0">
              ...
              <p className="text-xl text-zinc-600 max-w-lg">
                From stunning branding to high-converting websites and packaging
                — we craft designs that don't just look good, they perform.
              </p>

              <div className="flex flex-wrap gap-4 pt-6">
                <Link to="/portfolio"><button className="bg-orange-600 hover:bg-orange-700 text-white px-9 py-4 rounded-2xl font-semibold transition-all active:scale-95 shadow-lg shadow-orange-500/30">
                  Explore Our Work
                </button></Link>
               <Link to="/development"> <button className="border border-zinc-300 hover:border-zinc-400 text-zinc-700 px-9 py-4 rounded-2xl font-medium transition-all">
                  View Services
                </button></Link>
              </div>
            </div>
